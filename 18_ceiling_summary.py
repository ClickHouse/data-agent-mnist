"""Emit the figure inputs for the 60-turn ceiling board (AI-1540).
...
validates the method, and isolates gemini-3.5-flash at +135 (AI-1850).
...
def main():
    ...
    for m, v in ceil.items():
        ...
        models.append({
            ...
            # exactly the reasoning models (AI-1540).
