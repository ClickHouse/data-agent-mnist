...
The rows are committed as CSV under `examples/saas/data/`, and `seed_example.py` only
...
`examples/saas/warehouse/` and `examples/saas/out/` are generated and gitignored: chDB rewrites
